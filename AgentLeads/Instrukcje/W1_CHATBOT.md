...
> *"Przeczytaj plik W1_CHATBOT.md i zbuduj wszystko co jest opisane w sekcji Krok po kroku. Mój klucz API Google: tutaj_wklej_swoj_klucz
"*
...
- Użyj `npx create-next-app@latest C:\Users\rpawlak\Documents\L-Systems\AgentyAI` z TypeScript i App Router
...
- System prompt: "Jesteś pomocnym asystentem AI, który odpowiada za generowanie leadów dla sprzedaży systemu IFS Cloud. Odpowiadaj po polsku, zwięźle i konkretnie."
- Zwróć streaming response

### 4. Strona główna: `app/page.tsx`
- Użyj hooka `useChat` z `@ai-sdk/react` (komponent "use client")
- Elementy interfejsu:
  - Nagłówek z nazwą "Generator leadów" i emoji 🤖
...
## Oczekiwany rezultat
Po `npm run dev` na `http://localhost:3050`:
